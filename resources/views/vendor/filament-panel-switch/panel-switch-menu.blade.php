@php
    $canSwitchPanels = auth()->user()->hasRole('super_admin');

    $panels = collect($panels)->map(function ($panel) {
        return $panel instanceof \Filament\Panel ? $panel : \Filament\Facades\Filament::getPanel($panel);
    });
